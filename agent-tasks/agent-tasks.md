...
- **inc 5 (remaining) — CaMeL taint/sink-policy + Loop research-phase wiring** (gate tool calls whose args derive from tainted digests; route fetched content through the quarantine before the planner acts — a sprint-loops change). The orchestrator half of inc 5 is done.
