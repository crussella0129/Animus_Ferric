...
- [ ] **A2's taint posture is still undecided AND unvalidated live.** The E2 decision from ADR-075 is still open, and `--research` was not exercised against a real model this round.
